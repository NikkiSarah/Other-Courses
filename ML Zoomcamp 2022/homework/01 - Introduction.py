...
price_data = pd.read_csv("../Data/car_price_data.csv")
...
# 7h. Multiply the inverse of XTX with the transpose of X and then multiply the result by y. Call the result w.
w = XTX_inv @ X.T @ y
first_element = w[0]
first_element
